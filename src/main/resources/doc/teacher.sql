...
INSERT INTO `tbl_dept` VALUES (107, '传销部门', 0, '0', '1', '', NULL, '', NULL);
INSERT INTO `tbl_dept` VALUES (108, '传销部门', 0, '0', '1', '', NULL, '', NULL);
INSERT INTO `tbl_dept` VALUES (109, '传销部门', 7, '0', '0', '', NULL, '', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1023 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `tbl_menu` VALUES (1019, '系统测试', 0, 0, '#', 'M', '0', '', '#', '', NULL, '', NULL, '');
INSERT INTO `tbl_menu` VALUES (1020, '功能测试', 1019, 0, '#', 'C', '0', '#', '#', '', NULL, '', NULL, '');
INSERT INTO `tbl_menu` VALUES (1021, '宿舍管理', 0, 0, '#', 'M', '0', '#', '#', '', NULL, '', NULL, '');
INSERT INTO `tbl_menu` VALUES (1022, '429管理', 1021, 0, '#', 'C', '0', '#', '#', '', NULL, '', NULL, '');
